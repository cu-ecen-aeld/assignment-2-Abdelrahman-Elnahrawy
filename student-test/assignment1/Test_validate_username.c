...
void test_validate_my_username()
{
    ...
    char *testusername = malloc_username_from_conf_file();
    TEST_ASSERT_EQUAL_STRING_MESSAGE(myusername, testusername, "The username from my_username() does not match the username read from conf/username.txt");
    /**
